...
<body>
 ...
 <section class="main-pesquisa">
            ...
            <h5>Essas vagas foram selecionadas de acordo com o seu perfil. Não se preocupe, essa lista é alterada a cada nova vaga cadastrada no SIEC, para te manter sempre atualizado. </h5>
            <div class="main-pesquisa-conteudo">
              @foreach ($vagasRecomendadas as $vaga)
