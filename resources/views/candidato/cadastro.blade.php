...
<x-header />
    ...
    <form action="{{ route('candidato.create') }}" method="post" class="d-flex align-items-center justify-content-center w-75 m-auto">
        @csrf
        <div class="d-flex flex-column ms-5 w-75">
