...
<x-header />
    ...
    <form action="{{ route('candidato.updateCandidato') }}" method="post">
        ...
        <input type="text" id="nomeCandidato" class="" name="nomeCandidato" value="{{ $usuariosCandidatos['nome'] }}"><br>

        <label for="cpfCandidato">CPF (Cadastro de Pessoa Física): </label>
        <input type="text" id="cpfCandidato" class="" name="cpfCandidato" value="{{ $usuariosCandidatos['cpf'] }}"><br>
        ...
        <input type="text" id="telefoneCandidato" class="" name="telefoneCandidato" value="{{ $usuariosCandidatos['telefone'] }}"><br>
        ...
        <input type="text" id="experienciaCandidato" class="" name="experienciaCandidato" value="{{ $usuariosCandidatos['experiencia'] }}"><br>

        <label for="idiomasCandidato">Idiomas fluentes: </label>
        <input type="text" id="idiomasCandidato" class="" name="idiomasCandidato" value="{{ $usuariosCandidatos['idiomas'] }}"><br>

        <label for="formacaoCandidato">Formação: </label>
        <input type="text" id="formacaoCandidato" class="" name="formacaoCandidato" value="{{ $usuariosCandidatos['formacao'] }}"><br>
