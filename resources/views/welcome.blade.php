        ...
        <div class="row">
            <div class="col-md-12">
                <section-header class="section-header text-center pb-5">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur <br> adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                </section-header>
            </div>
            <div class="row">
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-white text-center bg-dark pb-2">
                        <div class="crad-body">
                            ...
                            <p class="lead">adipiscing elit, sed do eiusmod tempor incididunt ut labore</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-4">
   ...
   <div class="row">
     <div class="">
        <div class="card text-center">
          ...
          <p class="card-text">Lorem ipsum dolor sit amet, consectetur <br> adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
