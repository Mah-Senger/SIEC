   ...
   <div class="title">
    ...
    <div class="card">
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="#265894" class="bi bi-person-fill" viewBox="0 0 16 16">
          ...
          <div class="button">
            <a class="candidato" href="pagina13.html" role="button" style="color: white; text-decoration: none;">Candidato</a>
         </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="button">
          <a class="empresa" href="pagina4.html" role="button"  style="color: white;  text-decoration: none;">Empresa</a>
       </div>
    </div>
   </div>
  </body>
